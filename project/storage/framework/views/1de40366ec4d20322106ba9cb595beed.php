...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Directory enquiry')); ?></h5>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.listing.enquiry')); ?>"><?php echo e(__('Enquiry')); ?></a></li>
        </ol>
	</div>
</div>
            ...
            <div class="row px-3 py-3">
                <div class="bulk-delete-section">
                    <div class="select-box-section">
                        ...
                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-href="<?php echo e(route('admin.listing.enquiry.bulk.delete')); ?>" data-target="" id="bulk_apply"><?php echo app('translator')->get('Apply'); ?></button>
                    </div>
                </div>
            </div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-center"><?php echo e(__("You are about to delete this Enquiry. Every informtation under this enquiry will be deleted.")); ?></p>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               searching: true,
               ajax: '<?php echo e(route('admin.enquiry.datatables')); ?>',
               columns: [
                        { data: 'checkbox', name: 'checkbox' },
                        { data: 'created_at', name: 'created_at' },
                        { data: 'listing_id', name: 'listing_id' },
                        { data: 'listing_owner_id', name: 'listing_owner_id' },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\latest\listing\project\resources\views/admin/enquiry/index.blade.php ENDPATH**/ ?>