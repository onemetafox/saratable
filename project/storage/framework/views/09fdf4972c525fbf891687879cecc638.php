...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Edit Staff')); ?> <a class="btn btn-primary btn-rounded btn-sm" href="<?php echo e(route('admin.staff.index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h5>
    <ol class="breadcrumb py-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.staff.edit',$data->id)); ?>"><?php echo e(__('Edit Staff')); ?></a></li>
    </ol>
    </div>
</div>
  ...
  <div class="col-md-10">
    ...
    <div class="card mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('Edit Staff Form')); ?></h6>
      </div>

      <div class="card-body">
        
        <form class="geniusform" action="<?php echo e(route('admin.staff.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="inp-email" name="email"  placeholder="<?php echo e(__('Enter Email')); ?>" value="<?php echo e($data->email); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saratable\project\resources\views/admin/staff/edit.blade.php ENDPATH**/ ?>