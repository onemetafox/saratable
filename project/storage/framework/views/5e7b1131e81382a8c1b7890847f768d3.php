                ...
                <div class="dashboard-tlbar d-block mb-5">
                    <div class="row">
                        <div class="colxl-12 col-lg-12 col-md-12">
                            <h1 class="ft-medium"><?php echo app('translator')->get('Saved Listings'); ?></h1>
                            ...
                            <div class="dashboard-list-wraps bg-white rounded mb-4">
                                <div class="dashboard-list-wraps-head br-bottom py-3 px-3">
                                    <div class="dashboard-list-wraps-flx">
                                        <h4 class="mb-0 ft-medium fs-md"><i class="fa fa-file-alt me-2 theme-cl fs-sm"></i><?php echo app('translator')->get('Saved Listing'); ?></h4>
                                    </div>
                                </div>

                                <div class="dashboard-list-wraps-body py-3 px-3">
                                    <div class="dashboard-listing-wraps">
                                        <?php $__currentLoopData = $wishlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <!-- Single Listing Item -->
                                            <div class="dsd-single-listing-wraps">
                                                <div class="dsd-single-lst-thumb"><img src="<?php echo e(asset('assets/images/'.$data->listing->photo)); ?>" class="img-fluid" alt="" /></div>
                                                <div class="dsd-single-lst-caption">
                                                    <div class="dsd-single-lst-title"><h5><?php echo e($data->listing->name); ?></h5></div>
                                                    <span class="agd-location"><i class="lni lni-map-marker me-1"></i><?php echo e($data->listing->real_address); ?></span>

                                                    <?php if(count($data->listing->reviews)>0): ?>
                                                        <div class="ico-content">
                                                            <div class="Rego-ft-first">
                                                                ...
                                                                <div class="Rego-price-range">
                                                                    <span class="ft-medium"><?php echo e($data->listing->directoryRatting($data->listing->id)); ?> <?php echo app('translator')->get('Reviews'); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div class="dsd-single-lst-footer">
                                                        <a href="<?php echo e(route('front.listing.details',$data->listing->slug)); ?>" class="btn btn-view mr-1"><i class="fas fa-eye me-1"></i><?php echo app('translator')->get('View'); ?></a>
                                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#confirm-delete" data-href="<?php echo e(route('user.saved.listing.delete',$data->id)); ?>" class="btn btn-delete">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\latest\listing\project\resources\views/user/listing/saved.blade.php ENDPATH**/ ?>