            ...
            <div class="dashboard-tlbar d-block mb-5">
                <div class="row">
                    <div class="colxl-12 col-lg-12 col-md-12">
                        <h1 class="ft-medium"><?php echo app('translator')->get('Hotel Booking Request'); ?></h1>
                                ...
                                <div class="dashboard-bookings-wraps">
                                    <?php $__currentLoopData = $hotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="dsd-single-bookings-wraps">
                                            <div class="dsd-single-book-thumb"><img src="<?php echo e(asset('assets/images/'.$hotel->user->photo)); ?>" class="img-fluid circle" alt="" /></div>
                                            <div class="dsd-single-book-caption">
                                                <div class="dsd-single-book-title"><h5><?php echo e($hotel->user->name); ?><span class="bko-dates"><?php echo e($hotel->user->created_at->format('d M Y')); ?></span></h5></div>
                                                <div class="ico-content">
                                                    <ul>
                                                        <li>
                                                            <div class="px-2 py-1 medium bg-light-<?php echo e($hotel->status == 0 ? 'warning' :($hotel->status == 1 ? 'success':'danger')); ?> rounded text-<?php echo e($hotel->status == 0 ? 'danger' :($hotel->status == 1 ? 'success':'primary')); ?>">
                                                                <?php if($hotel->status == 0): ?>
                                                                    <?php echo app('translator')->get('Pending'); ?>
                                                                <?php elseif($hotel->status == 1): ?>
                                                ...
                                                <div class="dsd-single-descr">
                                                    <div class="dsd-single-item">
                                                        ...
                                                        <span class="dsd-item-info"><?php echo e($hotel->listing->name); ?></span>
                                                    </div>

                                                    <div class="dsd-single-item">
                                                        <span class="dsd-item-title"><?php echo app('translator')->get('Booking Date'); ?>:</span>
                                                        <span class="dsd-item-info"><?php echo e(Carbon\Carbon::parse($hotel->checkin_date)->format('d M Y')); ?> - <?php echo e(Carbon\Carbon::parse($hotel->checkout_date)->format('d M Y')); ?></span>
                                                    </div>

                                                    <div class="dsd-single-item">
                                                        <span class="dsd-item-title"><?php echo app('translator')->get('Member'); ?>:</span>
                                                        <span class="dsd-item-info"><?php echo e($hotel->adults); ?> <?php echo app('translator')->get('Adults'); ?>, <?php echo e($hotel->kids); ?> <?php echo app('translator')->get('Child'); ?></span>
                                                    </div>

                                                    <div class="dsd-single-item">
                                                        <span class="dsd-item-title"><?php echo app('translator')->get('Mail'); ?>:</span>
                                                        <span class="dsd-item-info"><?php echo e($hotel->user->email); ?></span>
                                                    </div>

                                                    <div class="dsd-single-item">
                                                        <span class="dsd-item-title"><?php echo app('translator')->get('Phone'); ?>:</span>
                                                        <span class="dsd-item-info"><?php echo e($hotel->user->phone); ?></span>
                                                    </div>
                                                </div>
                                                <div class="dsd-single-book-footer">
                                                    <?php if($hotel->status == 0): ?>
                                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#confirm-status" data-href="<?php echo e(route('user.booking.status',['id1' => $hotel->id, 'id2' => 1])); ?>" class="btn btn-aprd">
                                                            <i class="fas fa-check-circle me-1"></i>
                                                            <?php echo app('translator')->get('Approved'); ?>
                                                        </a>

                                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#confirm-status" data-href="<?php echo e(route('user.booking.status',['id1' => $hotel->id, 'id2' => 2])); ?>" class="btn btn-reject">
                                                            <i class="fas fa-trash me-1"></i>
                                                            <?php echo app('translator')->get('Reject'); ?>
                                                        </a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(route('user.booking.conversation',$hotel->id)); ?>" class="btn btn-message"><i class="fas fa-envelope me-1"></i><?php echo app('translator')->get('Message'); ?></a>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\latest\listing\project\resources\views/user/booking/hotel.blade.php ENDPATH**/ ?>