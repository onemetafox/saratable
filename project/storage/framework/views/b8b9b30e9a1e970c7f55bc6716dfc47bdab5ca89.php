...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Edit Category')); ?> <a class="btn btn-primary btn-rounded btn-sm" href="<?php echo e(route('admin.cblog.index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h5>
        <ol class="breadcrumb">
  ...
  <div class="col-md-10">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="<?php echo e(route('admin.cblog.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\htdocs\geniuslisting\project\resources\views/admin/cblog/edit.blade.php ENDPATH**/ ?>