...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Plans')); ?></h5>
        <ol class="breadcrumb">
        ...
        <div class="row px-3 py-3">
            <div class="bulk-delete-section">
                <div class="select-box-section">
                    ...
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-href="<?php echo e(route('admin.plans.bulk.delete')); ?>" data-target="" id="bulk_apply"><?php echo app('translator')->get('Apply'); ?></button>
                </div>
            </div>
        </div>
            ...
            <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th><?php echo e(__('Listing Limit')); ?></th>
                        <th><?php echo e(__('Listing Duration')); ?></th>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-center"><?php echo e(__("You are about to delete this Plans. Every informtation under this plan will be deleted.")); ?></p>
...
<?php $__env->startSection('scripts'); ?>
	...
	"use strict";
		...
		var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               searching: true,
               ajax: '<?php echo e(route('admin.plans.datatables')); ?>',
               columns: [
                        { data: 'checkbox', name: 'checkbox' },
                        { data: 'title', name: 'title' },
                        { data: 'price', name: 'price' },
                        { data: 'post_limit', name: 'post_limit' },
            ...
            $(".btn-area").append('<div class="col-sm-12 col-md-4 pr-3 text-right">'+
                '<a class="btn btn-primary" href="<?php echo e(route('admin.plans.create')); ?>">'+
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\htdocs\geniuslisting\project\resources\views/admin/plans/index.blade.php ENDPATH**/ ?>