...
<?php $__env->startSection('content'); ?>
    <?php if(in_array('Banner', $home_modules)): ?>
        <!-- ======================= Home Banner ======================== -->
        <div class="home-banner margin-bottom-0" style="background:#f41b3b url(<?php echo e(asset('assets/images/'.$gs->theme2_hero)); ?>) no-repeat;" data-overlay="5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-11 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <form class="main-search-wrap fl-wrap half-column" action="<?php echo e(route('front.listing')); ?>" method="GET">
                            ...
                            <div class="main-search-item">
                                <span class="search-tag"><?php echo app('translator')->get('Where'); ?></span>
                                                ...
                                                <div class="Rego-grid-wrap">
                                                    ...
                                                    <div class="Rego-grid-fl-wrap">
                                                        <div class="Rego-caption px-3 py-2">
                                                            ...
                                                            <div class="Rego-cates multi"><a href="<?php echo e(route('front.listing',['category' => $restaurant->category->slug])); ?>" class="cats-2"><?php echo e($restaurant->category->title); ?></a></div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                        ...
                        <div class="content_block_2 pr-3 py-4">
                            <div class="content-box">
                                <div class="sec-title light">
                                    <p class="theme-cl px-3 py-1 rounded bg-light-danger d-inline-flex"><?php echo e($ps->download_title); ?></p>
                                    <h2 class="ft-bold"><?php echo e($ps->download_subtitle); ?></h2>
                                </div>
                                <div class="text mb-3">
                                    <p>
                                        <?php echo e($ps->download_text); ?>

                                    </p>
                                </div>

                                <div class="btn-box clearfix mt-5">
                                    <a href="<?php echo e($ps->app_store_link); ?>" class="download-btn play-store me-1 d-inline-flex"><img src="<?php echo e(asset('assets/front/img/ios.png')); ?>" width="200" alt="" /></a>
                                    <a href="<?php echo e($ps->google_play_link); ?>" class="download-btn play-store ms-2 mb-1 d-inline-flex"><img src="<?php echo e(asset('assets/front/img/and.png')); ?>" width="200" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 image-column">
                        <div class="image-box">
                            <figure class="image">
                                <img src="<?php echo e(asset('assets/images/'.$ps->download_photo)); ?>" class="img-fluid" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\htdocs\geniuslisting\project\resources\views/frontend/theme/theme-2.blade.php ENDPATH**/ ?>