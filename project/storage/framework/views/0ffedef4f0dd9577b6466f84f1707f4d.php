<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-4">
        ...
        <form class="geniusform" action="<?php echo e(route('admin.profile.update')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="inp-website"><?php echo e(__('Website')); ?></label>
                <input type="text" class="form-control" id="inp-website" name="website" placeholder="<?php echo e(__('Enter Website')); ?>" value="<?php echo e($data->website); ?>" required>
            </div>

            <div class="form-group">
                <label for="inp-direction"><?php echo e(__('Direction')); ?></label>
                <input type="text" class="form-control" id="inp-direction" name="direction" placeholder="<?php echo e(__('Enter Direction')); ?>" value="<?php echo e($data->direction); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saratable\project\resources\views/admin/profile.blade.php ENDPATH**/ ?>