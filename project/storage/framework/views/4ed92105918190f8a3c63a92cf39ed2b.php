...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Process Section')); ?></h5>
	<ol class="breadcrumb">
		...
		<div class="card-body">
		  ...
		  <form class="geniusform" action="<?php echo e(route('admin.ps.update')); ?>" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="hero_title" name="process_title"  placeholder="<?php echo e(__('Enter About Title')); ?>" value="<?php echo e($data->process_title); ?>" required>
			  </div>

			  <div class="form-group">
				<label for="hero_subtitle"><?php echo e(__('Hero Subtitle')); ?></label>
				<input type="text" class="form-control" id="hero_subtitle" name="process_text"  placeholder="<?php echo e(__('Enter Subtitle')); ?>" value="<?php echo e($data->process_text); ?>" required>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="wrapper-image-preview">
					<div class="box full-width">
						<div class="back-preview-image" style="background-image: url(<?php echo e($data->process_photo ? asset('assets/images/'.$data->process_photo) : asset('assets/images/placeholder.jpg')); ?>);"></div>
						<div class="upload-options">
							<label class="img-upload-label full-width" for="img-upload"> <i class="fas fa-camera"></i> <?php echo e(__('Upload Picture')); ?> </label>
							<input id="img-upload" type="file" class="image-upload" name="process_photo" accept="image/*">
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           ...
           serverSide: true,
           searching: true,
           ajax: '<?php echo e(route('admin.account.process.datatables')); ?>',
           columns: [
        ...
        $(".btn-area").append('<div class="col-sm-12 col-md-4 pr-3 text-right">'+
            '<a class="btn btn-primary" href="<?php echo e(route('admin.account.process.create')); ?>">'+
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\latest\listing\project\resources\views/admin/account/index.blade.php ENDPATH**/ ?>