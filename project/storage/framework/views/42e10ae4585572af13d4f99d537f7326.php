      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="<?php echo e(route('admin.blog.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control summernote"  id="details" name="details" rows="3" placeholder="<?php echo e(__('Description')); ?>"><?php echo e($data->details); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\latest\listing\project\resources\views/admin/blog/edit.blade.php ENDPATH**/ ?>