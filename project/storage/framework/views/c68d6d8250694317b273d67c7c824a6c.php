                        ...
                        <div class="signup-screen-single">
                            ...
                            <form class="submit-form" id="loginform" action="<?php echo e(route('user.login.submit')); ?>" method="POST">
                                ...
                                <div class="form-group text-center mt-4 mb-0">
                                    <p class="mb-0"><?php echo app('translator')->get("You Don't have any account?"); ?> <a href="<?php echo e(route('user.register')); ?>" class="ft-medium text-success"><?php echo app('translator')->get('Sign Up'); ?></a></p>
                                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\latest\listing\project\resources\views/user/login.blade.php ENDPATH**/ ?>