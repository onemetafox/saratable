...
<head>
  ...
  <link href="{{ asset('assets/admin/vendor/clock-picker/clockpicker.css') }}" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="{{ asset('assets/admin/vendor/clock-picker/clockpicker.css') }}"></script>
