        ...
        <form class="geniusform" action="{{route('admin.role.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="section[]" value="Directory Restaurant" {{ $data->sectionCheck('Directory Restaurant') ? 'checked' : '' }} class="custom-control-input" id="Directory Restaurant">
