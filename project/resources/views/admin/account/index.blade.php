...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Process Section') }}</h5>
	<ol class="breadcrumb">
		...
		<div class="card-body">
		  ...
		  <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="hero_title" name="process_title"  placeholder="{{ __('Enter About Title') }}" value="{{ $data->process_title }}" required>
			  </div>

			  <div class="form-group">
				<label for="hero_subtitle">{{  __('Hero Subtitle')  }}</label>
				<input type="text" class="form-control" id="hero_subtitle" name="process_text"  placeholder="{{ __('Enter Subtitle') }}" value="{{ $data->process_text }}" required>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="wrapper-image-preview">
					<div class="box full-width">
						<div class="back-preview-image" style="background-image: url({{ $data->process_photo ? asset('assets/images/'.$data->process_photo) : asset('assets/images/placeholder.jpg') }});"></div>
