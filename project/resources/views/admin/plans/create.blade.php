      ...
      <div class="card-body py-5">
        ...
        <form class="geniusform" action="{{route('admin.plans.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="prev_price" name="prev_price" placeholder="{{ __('Plan Previous Price') }}" min="0" step="0.01" value="">
            </div>
            ...
            <div class="form-group">
                <label for="limit">{{ __('Ad Duration') }} (@lang('Days'))</label>
