	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-center">{{__("You are about to delete this Restaurant. Every informtation under this restaurant will be deleted.")}}</p>
...
@section('scripts')
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               searching: true,
               ajax: '{{ route('admin.booking.datatables',['type'=>'restaurant']) }}',
               columns: [
