...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.categories.edit',$data->id) }}">{{ __('Edit Category') }}</a></li>
        </ol>
	</div>
</div>
        ...
        <form class="geniusform" action="{{route('admin.categories.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" name="is_top" class="form-check-input" value="1" id="is_top" {{ $data->is_top == 1 ? 'checked' : ''}}>
