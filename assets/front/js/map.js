...
function getInfoBox(o) {
    return new InfoBox({
        content:
            '<div class="map-popup-wrap"><div class="map-popup"><div class="Rego-grid-wrap"><div class="Rego-grid-upper"><div class="Rego-bookmark-btn"><button type="button"><i class="lni lni-heart-filled position-absolute"></i></button></div><div class="Rego-grid-thumb"><a href="' +o.listingimgURL +'" class="d-block text-center m-auto"><img src="' +o.listingImg +'" class="img-fluid" alt=""></a></div></div><div class="Rego-grid-fl-wrap"><div class="Rego-caption px-3 py-2"><div class="Rego-author"><a href="' +o.authorURL +'"><img src="' +o.authorImg +'" class="img-fluid circle" alt=""></a></div><div class="Rego-cates"><a href="' +o.listingcategoryURL +'">' +o.listingCategory +'</a></div><h4 class="mb-0 ft-medium medium"><a href="' +o.listingURL +'" class="text-dark fs-md">' +o.listingTitle +'</a></h4><div class="Rego-middle-caption mt-3"><div class="Rego-location"><i class="fas fa-map-marker-alt"></i>' +o.listingLocation +'</div><div class="Rego-call"><i class="fas fa-phone-alt"></i>' +o.listingCall +'</div></div></div><div class="Rego-grid-footer py-3 px-3"><div class="Rego-ft-last"><span class="small">' +o.listingTime +'</span></div></div></div></div></div></div>',
        disableAutoPan: !1,
        maxWidth: 0,
