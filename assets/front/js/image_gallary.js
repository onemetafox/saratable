...
$(document).on("click", ".set-gallery" , function(){
                  ...
                  if(data[0] == 0)
                  {
                    ...
                    $('.selected-image .row').append('<div class="col-sm-6">'+
                                    '<div class="img gallery-img">'+
                                        ...
                                        '</span>'+
                                        '<a href="'+mainurl+'/assets/images/'+arr[k]['photo']+'" target="_blank">'+
                                        '<img src="'+mainurl+'/assets/images/'+arr[k]['photo']+'" alt="gallery image">'+
                                        '</a>'+
                                    '</div>'+
                                  '</div>');
                      }                         
  ...
  $(document).on('click', '#property_gallery_edit' ,function() {
    $('#property_upload_gallery_edit').click();
  });
                                    
                            
  $("#property_upload_gallery_edit").change(function(){
    $("#form-gallery").submit();  
  });
